    ...
    vec![
        ...
        AlgorithmEntry {
            ...
            samples: CodeSamples {
                ...
                rust: rs!(
                    "fn dijkstra(g: &[Vec<(usize,i32)>], s: usize) -> Vec<i32> {",
                    "    let mut dist = vec![i32::MAX; g.len()];",
                    "    let mut pq = BinaryHeap::new();",
                    "    dist[s]=0; pq.push(Reverse((0,s)));",
        ...
        AlgorithmEntry {
            algorithm: "topological-sort".into(),
            ...
            samples: CodeSamples {
                cpp: cpp!(
                    ...
                    "  int n=g.size(); vector<int> indeg(n,0), res;",
                ...
                rust: rs!(
                    ...
                    "    for es in g { for &v in es { indeg[v]+=1; } }",
                    "    let mut q: VecDeque<_> = (0..n).filter(|&i| indeg[i]==0).collect();",
                    "    let mut res = vec![];",
        ...
        AlgorithmEntry {
            ...
            samples: CodeSamples {
                ...
                rust: rs!(
                    "fn kruskal(edges: &mut [(i32,usize,usize)], n: usize) -> i32 {",
                    ...
                    "            parent[find(&mut parent,u)]=find(&mut parent,v);",
                    "            cost += w;",
                    "        }",
                    "    }",
                    "    cost",
        ...
        AlgorithmEntry {
            ...
            samples: CodeSamples {
                cpp: cpp!(
                    ...
                    "    if(vis[u]) continue; vis[u]=true; cost+=w;",
                    "    for(auto [v,w2]:g[u])",
